...
Route::group(['middleware' => ['satker']], function () {
    ...
    Route::post('ubah-anggaran', ['as' => 'ubah-anggaran', 'uses' => 'AnggaranController@submit']);
...
Route::group(['middleware' => ['reviewer']], function () {
    ...
    Route::post('proses-internal/{id}','InputTambahanController@prosesinternal');
    Route::post('proses-eksternal/{id}','InputTambahanController@proseseksternal');
