						...
						<div class="form-group">
							<div class="col-xs-12">
								<ul class="nav nav-pills nav-justified clickable-steps">
									...
									<li>
										<a href="javascript:void(0)" data-gotostep="clickable-fifth">
											<strong>Lomba Kreasi Kreatif <br> <big>15%</big></strong>
										</a>
									</li>
									<li>
										<a href="javascript:void(0)" data-gotostep="clickable-sixth">
											<strong>Survey Budaya Internal <br> <big>15%</big></strong>
										</a>
									</li>
									<li>
										<a href="javascript:void(0)" data-gotostep="clickable-seventh">
											<strong>Survey Budaya Eksternal <br> <big>15%</big></strong>
										</a>
									</li>
								</ul>
							</div>
						...
						<div class="form-group">
							<div class="col-xs-12">
								<ul class="nav nav-pills nav-justified clickable-steps">
									...
									<li>
										<a href="javascript:void(0)" data-gotostep="clickable-fourth">
											<strong><i class="fa fa-check"></i>Kecepatan Pelaporan <br> <big>15%</big></strong>
										</a>
									</li>
									<li class="active">
										<a href="javascript:void(0)" data-gotostep="clickable-fifth">
						...
						<div class="form-group">
							<div class="col-xs-12">
								<ul class="nav nav-pills nav-justified clickable-steps">
									...
									<li>
										<a href="javascript:void(0)" data-gotostep="clickable-fifth">
											<strong><i class="fa fa-check"></i>Lomba Kreasi Kreatif <br> <big>15%</big></strong>
										</a>
									</li>
									<li class="active">
										<a href="javascript:void(0)" data-gotostep="clickable-sixth">
						...
						<div class="form-group">
							<div class="col-xs-12">
								<ul class="nav nav-pills nav-justified clickable-steps">
									...
									<li>
										<a href="javascript:void(0)" data-gotostep="clickable-sixth">
											<strong><i class="fa fa-check"></i>Survey Budaya Internal <br> <big>15%</big></strong>
										</a>
									</li>
									<li class="active">
										<a href="javascript:void(0)" data-gotostep="clickable-seventh">
