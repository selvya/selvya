				...
				<div class="row">
					<div class="col-xs-6">
						...
						<div class="pie-chart block-section" data-percent="70" data-line-width="2" data-bar-color="#1bbae1" data-track-color="#ffffff">
							<img src="{{asset('vendor/img/placeholders/avatars/avatar14.jpg')}}" alt="avatar" class="pie-avatar img-circle">
						</div>
					</div>
					<div class="col-xs-6">
						<div class="pie-chart block-section" data-percent="25" data-line-width="2" data-bar-color="#9d1be1" data-track-color="#ffffff">
							<img src="{{asset('vendor/img/placeholders/avatars/avatar13.jpg')}}" alt="avatar" class="pie-avatar img-circle">
						</div>
					</div>
					<div class="col-xs-6">
						<div class="pie-chart block-section" data-percent="45" data-line-width="2" data-bar-color="#1be1a2" data-track-color="#ffffff">
							<img src="{{asset('vendor/img/placeholders/avatars/avatar7.jpg')}}" alt="avatar" class="pie-avatar img-circle">
						</div>
					</div>
					<div class="col-xs-6">
						<div class="pie-chart block-section" data-percent="90" data-line-width="2" data-bar-color="#e17d1b" data-track-color="#ffffff">
							<img src="{{asset('vendor/img/placeholders/avatars/avatar9.jpg')}}" alt="avatar" class="pie-avatar img-circle">
						</div>
					</div>
					<div class="col-xs-6">
						<div class="pie-chart block-section" data-percent="60" data-line-width="2" data-bar-color="#e11b1b" data-track-color="#ffffff">
							<img src="{{asset('vendor/img/placeholders/avatars/avatar11.jpg')}}" alt="avatar" class="pie-avatar img-circle">
						</div>
					</div>
					<div class="col-xs-6">
						<div class="pie-chart block-section" data-percent="20" data-line-width="2" data-bar-color="#e11b8b" data-track-color="#ffffff">
							<img src="{{asset('vendor/img/placeholders/avatars/avatar6.jpg')}}" alt="avatar" class="pie-avatar img-circle">
						</div>
					</div>
				</div>
			</div>
