                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="kantor" class="form-control">
                                <option value="Pusat" @if($map->kantor == 'Pusat') selected @endif>Kantor Pusat</option>
                                <option value="Regional" @if($map->kantor == 'Regional') selected @endif>Kantor Regional</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
